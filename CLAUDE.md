...
> Заполнено по утверждённой `ARCHITECTURE.md` 0.8 (PRODUCT.md 1.2), дополнено до 0.14. Команды ниже фактические — проверены выполнением (последний раз — TASK-007); детали и обоснование решений — ARCHITECTURE 4 и 4.1–4.11.
