...
> Заполнено по утверждённой `ARCHITECTURE.md` 0.8 (PRODUCT.md 1.2), дополнено до 0.11. Команды ниже фактические — проверены выполнением (последний раз — TASK-006); детали и обоснование решений — ARCHITECTURE 4 и 4.1–4.8.
