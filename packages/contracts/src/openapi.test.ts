...
describe("buildOpenApiDocument", () => {
  it("produces an OpenAPI 3.1 document with every contract route", () => {
    ...
    expect(Object.keys(document.paths).sort()).toEqual([
      ...
      "/admin/discipline/{markId}/revoke",
      "/admin/order-extension-candidates",
      "/admin/order-extensions",
      "/admin/orders",
      "/admin/orders/{orderId}",
      "/admin/orders/{orderId}/close",
      "/admin/orders/{orderId}/extend-deadline",
      "/admin/settings",
      "/admin/settings/{key}",
      ...
      "/admin/suppliers/{supplierId}/members",
      "/admin/suppliers/{supplierId}/members/{memberId}/contact-person",
      "/admin/suppliers/{supplierId}/members/{memberId}/invitations",
      "/admin/suppliers/{supplierId}/members/{memberId}/restore",
      "/admin/suppliers/{supplierId}/offers",
      "/admin/suppliers/{supplierId}/pause",
      "/admin/suppliers/{supplierId}/schedule",
      "/admin/suppliers/{supplierId}/sessions",
      "/admin/suppliers/{supplierId}/sessions/end",
      "/admin/suppliers/{supplierId}/sessions/{sessionId}/end",
      ...
      "/supplier/me",
      "/supplier/members",
      "/supplier/members/{memberId}",
      "/supplier/offer-receipt-preview",
      "/supplier/offers",
      "/supplier/offers/{offerId}",
      "/supplier/offers/{offerId}/return",
      "/supplier/offers/{offerId}/withdraw",
      "/supplier/orders",
      "/supplier/orders/close",
