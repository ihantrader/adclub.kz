...
- В рабочем дереве обнаружена не относящаяся к этой задаче незакоммиченная директория `design/` (SVG-иконки и логотипы бренда, `design/brand/*`) — не создана этой сессией, вне scope TASK-005.A, не коммитилась и не трогалась.
