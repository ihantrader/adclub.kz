...
- `pnpm test` (корень) — **PASS** — 15 задач; `@adclub/api`: 25 файлов, 247 тестов; всего по репозиторию 570 тестов.
...
- CI на `main` (GitHub Actions) — см. раздел «Acceptance Criteria», AC-12.
