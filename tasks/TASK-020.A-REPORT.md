...
- **AC-7 — PASS.** Коммиты — только явные пути (раздел Commits), правки Product Owner — отдельным коммитом `86efa0f`. CI: CI_RUNS
...
- Коммит отчёта — `tasks/TASK-020.A-REPORT.md` (этот файл); затем — коммит с записью CI-прогона коммита отчёта.
