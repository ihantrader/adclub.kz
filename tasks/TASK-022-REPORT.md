...
8. Коммит с отчётом — `tasks/TASK-022-REPORT.md`.
...
| CI на `main` | PASS (со второго коммита) | run 36129016015 — failure на образе MinIO, не на коде (то же падение воспроизвёл перезапуск прогона предыдущего коммита — 35899683472); после починки образа run 36133377025 — success |
